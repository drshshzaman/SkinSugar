      ...
      <div className="container mx-auto mb-72">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8  grid grid-cols-2 text-center gap-4   md:justify-center max-sm:flex max-sm:items-center max-sm:justify-center  mb-10 ">
              <Tab>
                <button
                  type="button"
            ...
            {/* product  */}
            <TabPanel className="max-sm:ml-56">
            ...
            <TabPanel className="max-sm:overflow-visible max-sm:ml-96">
